...
import ydhnwb from './../../assets/imgs/logo192.png';
    ...
    return (
        <nav className="max-w-screen-xl mx-auto grid grid-flow-col">
            <div className="flex flex-row items-center">
                <img alt="" className="rounded-full object-cover" src={ydhnwb} width={32} height={32} />
                <a href="/"><span className="ml-4 text-xl tracking-tight text-gray-700 dark:text-white"> Prieyudha Akadita S</span></a>
            ...
            <div className="md:items-center md:w-auto flex justify-end">
                ...
                <div className="flex">
                    <div onClick={changeTheme} className="flex flex-row items-center cursor-pointer">
                        {
                            theme === 'dark' ?
